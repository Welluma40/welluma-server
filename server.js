...
app.post('/send-summary-fax', async (req, res) => {
  try {
    const { faxNumber, providerName, visitDate, summary, recommendations, medications, followUp } = req.body;
    ...
    const faxContent = `WELLUMA HEALTH — PATIENT VISIT SUMMARY
Date: ${visitDate}
To: ${providerName}
...
---
DISCLAIMER: This summary was generated by Welluma AI and shared at the patient's request. It may contain speech recognition errors. It is not a substitute for clinical documentation. Please treat this information with appropriate confidentiality.
